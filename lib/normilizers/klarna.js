export const klarnaNormalizer = orderData => {
  try {
    ...
    return Promise.resolve({
      customer: {
        ...
        birthDate: orderData.customer.date_of_birth,
        addresses: [
          {
            type: 'billing',
            firstName: customerName[0],
      ...
      total: {
        ...
        tax: {
          name: '',
          percent: Math.trunc(
            (orderData.order_tax_amount / orderData.order_amount) * 100
          )
        }
      }
    });
